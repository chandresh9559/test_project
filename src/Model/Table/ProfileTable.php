...
class ProfileTable extends Table
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ->scalar('phone')
            ->maxLength('phone', 11,'Phone number must be wethin 10 t0 11 character')
            ->minLength('phone', 10,'Phone number must be wethin 10 t0 10 character')
        ...
        $validator
            ...
            ->notEmptyString('gender','Select your gender');
        ...
        $validator
            ...
            ->notEmptyString('address','Please add your address');
