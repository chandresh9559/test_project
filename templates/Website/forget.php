    ...
    <!-- ======= Body Content ======= -->
        <div class="container-fluid mt-4 py-4 register">
            <div class="row">
                ...
                <div class="col-md-6">
                    <h2 class="my-4 pt-4 text-light">Forget Password</h2>
                    <fieldset>
                        <?php
                    ...
                    <?= $this->Form->button('Send Link', ['type' => 'submit','class'=>'btn btn-primary mt-3 text-center']); ?>
                    <?= $this->Form->end() ?>
                    <p class="text-light">If you are new user please <a href="login" class="btn-services scrollto">Login here</a></p>
                </div>
                <div class="col-md-3"></div>
            </div>
        </div>
