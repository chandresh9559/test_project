...
$this->Breadcrumbs->add([
    ...
    ['title' => 'User_Profile<span>></span>', 'url' => ['controller' => 'Users', 'action' => 'user_view'], 'options' => ['class' => 'active']],
]);
?>
    </div>
    <!-- ======= Bredcrumb ======= -->
    ...
    <div class="container-fluid mt-4 py-4 register">
        <div class="row">
            ...
            <div class="col-md-6">
                <h2 class="my-4 pt-4 text-light">User Profile</h2>
                ...
                <?=$this->Html->link(__('Back To List'), ['action' => 'user_list'], ['class' => 'btn btn-primary mt-4'])?>
                <?=$this->Form->end()?>
