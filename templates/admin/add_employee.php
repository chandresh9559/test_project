    ...
    <!-- ======= Body Content ======= -->
        <div class="container-fluid mt-4 py-4 register">
            <div class="row">
                ...
                <div class="col-md-6">
                    <h2 class="my-4 pt-4 text-light">Employee Registration Form</h2>
                    <?= $this->Form->create($user,["enctype" => "multipart/form-data"]) ?>
                    <fieldset>
                        
                        <div>
                            <?php echo $this->Form->control('emp_id',['class'=>'form-control border border-secondary','required'=>false]);?>
